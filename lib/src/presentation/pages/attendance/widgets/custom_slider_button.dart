...
/// Use a GlobalKey to access the state. This is the only way to call [CustomSlideActionState.reset]
class CustomSlideActionState extends State<CustomSlideAction>
